...
-- ---------------------------------------------------------------------
-- Comanda de mesa agora captura o cliente logo na abertura (não só na
-- hora de pagar) — pedidos.cliente_id, propagado pra venda e pro KDS.
-- finalizar_pedido_mesa redeclarada aqui: usa o cliente do pedido quando
-- nenhum p_cliente_id é passado explicitamente.
-- ---------------------------------------------------------------------
